...
#每次运行需要修改model_id和数据集
    ...
    parser.add_argument('--model_id', type=str, required=False, default='110182320_inverse_test', help='model id')
    ...
    parser.add_argument('--weight_decay', type=float, default=0.01, help='optimizer weight_decay')
